...
const Image = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-gray-100 to-gray-50 text-white flex flex-col items-center justify-center py-10 px-4">
      <div className="max-w-2xl w-full bg-white text-gray-900 rounded-lg shadow-xl p-8">
        ...
        <button
          ...
          className="w-full bg-gradient-to-r from-blue-500 to-purple-600 text-white font-semibold py-3 rounded-lg shadow-md hover:opacity-90 focus:outline-none focus:ring-4 focus:ring-purple-300"
        >
          Upload Image
        </button>
