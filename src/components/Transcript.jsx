...
const Transcript = () => {
  ...
  const handleFileUpload = async () => {
    ...
    try {
      ...
      const apiResponse = await axios.post('https://transcript-yuhg.onrender.com/transcribe', {
        videoUrl: ""+fileViewUrl,
      });
      const atres=await axios.post('https://fake-news-detection-fjr4.onrender.com/verify-news',{news_query:""+apiResponse.data.transcript});
